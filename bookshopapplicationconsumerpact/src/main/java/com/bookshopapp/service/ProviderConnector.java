...
public class ProviderConnector {
    ...
    public ProviderConnector(String userServiceRootri, RestTemplateBuilder restTemplateBuilder, ObjectMapper objectMapper) {
        this.restTemplate = restTemplateBuilder
                .rootUri(URI.create(userServiceRootri).toString())
